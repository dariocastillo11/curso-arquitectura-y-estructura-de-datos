...
public:
Semana_Laboral(char, int);
~Semana_Laboral();
void ingresarNombreEmpleado();
void obtenerNombreEmpleado();
void ingresarDniEmpleado(int);
void estableceIngreso(int);
void estableceSalida(int);
void obtenerHorasSemanales();
void guardarPersona(char, int);
private:
Tiempo horario[5][2];
char nombreEmpleado;
int dniEmpleado;
...
Semana_Laboral::Semana_Laboral(char nombre, int dni){
cout<<"se crea constructor de persona";
guardarPersona(nombre,dni);

}
void Semana_Laboral:: ingresarNombreEmpleado(){
cout<<"Ingrese nombre de empleado: \n";
cin>>nombreEmpleado;
}
void Semana_Laboral:: obtenerNombreEmpleado(){
cout<<"El emplado es: "+nombreEmpleado< }

void Semana_Laboral:: ingresarDniEmpleado(int dni){

}
void Semana_Laboral:: estableceIngreso(int dia){

}
void Semana_Laboral:: estableceSalida(int dia){

}
void Semana_Laboral:: obtenerHorasSemanales(){

}
void Semana_Laboral:: guardarPersona(char nombre, int dni){
